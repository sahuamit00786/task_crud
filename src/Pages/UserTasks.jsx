...
const UserTasks = () => {
    ...
    useEffect(()=>{
        const getUserData = async()=>{
            try {
                const res = await fetch(`https://task-api-9cyg.onrender.com/api/getTask/${id}`,{
                method:'GET',
                headers:{
  ...
  const handleChange = (e) => {
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            const res = await fetch('https://task-api-9cyg.onrender.com/api/newTask',{
                method:'POST',
                headers:{
                    'Content-Type':'application/json',
                },
    ...
    const handleReAssign = async(id)=>{
        ...
        try {
            const res = await fetch(`https://task-api-9cyg.onrender.com/api/reAssignTask/${id}`,{
                method:'PUT',
                headers:{
                    'Content-Type':'application/json',
                },
     ...
     const handleEdit = async(id)=>{
        ...
        settaskKey(id)
        try {
            const res = await fetch(`https://task-api-9cyg.onrender.com/api/editTask/${id}`,{
                method:'PUT',
                headers:{
                    'Content-Type':'application/json',
                },
     ...
     const handleDelete = async(id)=>{
        ...
        try {
            const res = await fetch(`https://task-api-9cyg.onrender.com/api/deleteTask/${id}`,{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json'
            },
